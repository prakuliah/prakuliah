...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
    <tr>
        <td align='center'>
            <button onclick='window.location.href=\"http://" . HOST . "/prakuliah/reset-password.html?id=" . $resetID . "\"' style='background-image: linear-gradient(#4776E6, #8E54E9); padding-left: 20px; padding-right: 20px; height: 40px; border: 0; border-radius: 3px; color: white; font-size: 15px; cursor: pointer;'>Atur Ulang Kata Sandi</button>
        </td>
    </tr>
</table>
